...
export const templateDetails = {
  name: 'NYXIS SHOES Ecommerce NextJS Template',
  description:
    'Presenting NYXIS SHOES Template, the ultimate ecommerce template in NextJS.',
  screenshotsOne: [
    preview,
    collection,
    singleProduct,
...
export const midSection = {
  ...
  description:
    'Take a look at our collection of 100+ premium Templates at nyxis.tech.',
  href: 'https://www.nyxis.tech',
};
...
export const buyTemplate = {
  heading: 'Buy Template on nyxis.tech',
  description:
    'Take a look at our collection of 100+ premium Templates at nyxis.tech.',
  href: 'https://www.nyxis.tech',
  coverImage: showcase2,
