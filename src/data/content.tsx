...
export const footerBannerData = {
  ...
  description:
    'View all brands of our collection on NYXIS SHOES, there is another collection. Please check it out bro, like seriously',
};

export const footerData = {
  description:
    'NYXIS SHOES was designed and founded in 2023 by Person. The theme is about sneakers ecommerce thet use for shoes selling around the world.',
  footerLinks: [
    {
      title: 'Main Pages',
      links: [
...
export const newsletter = {
  ...
  description:
    'Drop your email below and start receiving the best offers from NYXIS SHOES',
};
  ...
  directContactInfo: [
    {
      ...
      contactLink: {
        href: 'mailto:sales@NYXIS SHOES.com',
        title: 'sales@NYXIS SHOES.com',
      },
    },
    {
